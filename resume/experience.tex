...
\begin{cventries}
  ...
  {
    \begin{cvitems}
      \item {Redesigning Algebra curricula to better suit classes of mixed ability}
      \item {Pivoting to incorporate advanced projects and opportunities to suit student interests}
      \item {Creating new curricula for Personal Finance and Economics}
      \item {Leading parent conferences and keeping in regular contact with families}
    \end{cvitems}
  }
